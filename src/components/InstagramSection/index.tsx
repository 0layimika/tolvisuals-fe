...
export default function InstagramSection() {
  ...
  return (
    <section
      ...
      className="w-full my-12  lg:opacity-0   transition-opacity duration-300 hover:opacity-100 cursor-pointer bg-[#807c7c] py-24 flex items-center justify-center relative"
    >
